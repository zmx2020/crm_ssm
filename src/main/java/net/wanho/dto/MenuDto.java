...
public class MenuDto {
	...
	public MenuDto(Integer menu_id, String menu_name, String menu_url, String pictures, String status,
			Timestamp create_time, Timestamp update_time, Integer parent_menu_id, String parent_menu_name) {
		super();
	...
	public String toString() {
		return "MenuDto [menu_id=" + menu_id + ", menu_name=" + menu_name + ", menu_url=" + menu_url + ", pictures="
				+ pictures + ", status=" + status + ", create_time=" + create_time + ", update_time=" + update_time
				+ ", parent_menu_id=" + parent_menu_id + ", parent_menu_name=" + parent_menu_name + "]";
	}
