...
<body class="navbar-top">
			...
			<div class="widget-container fluid-height clearfix">
				<div class="heading clearfix">
					<i class="icon-table"></i> 菜单管理 <a
						...
						href="MenuServlet/getAllParentMenu"><i
						class="icon-plus"></i> 创建菜单</a>
				</div>
				<div class="widget-content padded clearfix">
					<div class="dataTables_filter">
						<form class="form-inline" action="MenuServlet/getAllMenu"
							method="post">
							<div class="btn-group">
	...
	<script type="text/javascript">
		...
		function changePage(num) {
			window.location.href = "${pageContext.request.contextPath}/MenuServlet/getAllMenu?currentPage=" + num;
		}
		...
		function deleteMenu(menu_id) {
			if (confirm("删除后不可恢复，确认删除？")) {
				...
				$
						.ajax({
							type : 'post',
							url : '${pageContext.request.contextPath}/MenuServlet/checkDeleteMenuId',
							data : data,
							dataType:"json",
							cache : false,
							sync : true,
							success : function(data) {
								...
								if (false == data.status) {
									...
									location.href = '${pageContext.request.contextPath}/MenuServlet/deleteMenuById?menu_id='
											+ menu_id;
								}
							},
							error : function() {
		...
		function updateMenu(menuId) {
			...
			location.href = 'MenuServlet/getUpdateMenudetailById?menuId='+menuId;
		}
	</script>
</body>
